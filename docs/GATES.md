...
| **Full folded sweep** (in-repo) | **62/62** | every selftest-bearing module runs green through the fold (the sweep grows with the spine; the reconciled map of every battery lives in [BATTERIES.md](BATTERIES.md)) |
