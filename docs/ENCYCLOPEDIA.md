...
**State at generation:** 79 runnable scripts · 60 carry selftest gates · 69 stdlib-only · 79 licensed · 110 internal import edges · generated 2026-08-08T04:43:26Z (run mode).
...
- **Test batteries:** `test_chiron`, `test_grow`, `test_local_cors`, `test_mcp_server`
- **Most depended-upon (the spine's hubs):** `chiron` (48 dependents), `legal_corpus` (7 dependents), `govern` (6 dependents), `run_ledger` (5 dependents), `semic` (4 dependents)
...
- **Last gate run:** green in 229.0 ms
...
- **Last gate run:** green in 300.1 ms
...
- **Facts:** roles: server · selftest: yes · deps: stdlib only · imports: `chiron`, `console_server`, `heartbeat`, `llm_providers`, `president_grow`, `run_ledger` · imported by: `test_local_cors`
...
- **Last gate run:** green in 210.3 ms
...
- **Last gate run:** green in 266.8 ms
...
- **Last gate run:** green in 181.6 ms
...
- **Last gate run:** green in 181.2 ms
...
- **Last gate run:** green in 59.5 ms
...
- **Last gate run:** green in 45.3 ms
...
- **Last gate run:** green in 195.9 ms
...
- **Last gate run:** green in 161.0 ms
...
- **Last gate run:** green in 83.7 ms
...
- **Facts:** roles: builder · selftest: yes · deps: stdlib only
- **Last gate run:** green in 28.5 ms
...
- **Last gate run:** green in 174.8 ms
...
- **Last gate run:** green in 165.0 ms
...
- **Last gate run:** green in 5054.7 ms
...
- **Last gate run:** green in 200.0 ms
...
- **Last gate run:** green in 179.5 ms
...
- **Facts:** roles: server · selftest: yes · deps: stdlib only · imports: `run_ledger` · imported by: `assistant_server`, `stress_test`, `test_local_cors`
...
- **Last gate run:** green in 184.9 ms
...
- **Last gate run:** green in 260.4 ms
...
- **Last gate run:** green in 291.3 ms
...
- **Last gate run:** green in 179.0 ms
...
- **Facts:** selftest: yes · deps: stdlib only
- **Last gate run:** green in 31.8 ms
...
- **Last gate run:** green in 207.4 ms
...
- **Last gate run:** green in 168.8 ms
...
- **Last gate run:** green in 345.8 ms
...
- **Last gate run:** green in 222.6 ms
...
- **Facts:** selftest: yes · deps: stdlib only
- **Last gate run:** green in 215.7 ms
...
- **Last gate run:** green in 186.3 ms
...
- **Last gate run:** green in 165.1 ms
...
- **Last gate run:** green in 323.6 ms
...
- **Last gate run:** green in 47.7 ms
...
- **Last gate run:** green in 173.7 ms
...
- **Last gate run:** green in 50.7 ms
...
- **Facts:** selftest: yes · deps: stdlib only · imports: `chiron`, `govern`
- **Last gate run:** green in 170.4 ms
...
- **Last gate run:** green in 69.7 ms
...
- **Facts:** roles: server · selftest: yes · deps: stdlib only · imports: `attest`, `full_stack`
- **Last gate run:** green in 286.2 ms
...
- **Last gate run:** green in 178.5 ms
...
- **Last gate run:** green in 188.9 ms
...
- **Last gate run:** green in 181.5 ms
...
- **Last gate run:** green in 172.8 ms
...
- **Facts:** selftest: yes · deps: numpy · imports: `chiron`
- **Last gate run:** green in 256.2 ms
...
- **Last gate run:** green in 190.7 ms
...
- **Last gate run:** green in 38.4 ms
...
- **Last gate run:** green in 707.3 ms
...
- **Last gate run:** green in 67.9 ms
...
- **Last gate run:** green in 61.1 ms
...
- **Facts:** selftest: yes · deps: numpy · imports: `chiron`
- **Last gate run:** green in 217.7 ms
...
- **Last gate run:** green in 175.0 ms
...
- **Last gate run:** green in 15279.5 ms
...
- **Last gate run:** green in 1050.4 ms
...
- **Last gate run:** green in 373.0 ms
...
- **Last gate run:** green in 211.0 ms
...
- **Last gate run:** green in 2137.9 ms
