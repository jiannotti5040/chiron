# Chiron — Private Grow (`growth`)

This is the **operator's own growing memory** — the true *growth* (Latin: "to
...
grow-private/
  ...
  chiron_memory.json     the growing private memory
...
memory + crawl cursor (saving locally and to GitHub). Resume is robust: the local
cursor, the cursor committed to git, and the memory's own `ingested_sources`
