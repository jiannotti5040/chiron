...
The public grow (`Chiron/grow-public/`) may contain knowledge **derived** from public
sources. Chiron stores compressed, derived representations (generators, invariants,
